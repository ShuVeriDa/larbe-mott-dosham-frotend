...
const localizedPath = (lang: string) => `/${lang}/favorites`;
...
export const generateMetadata = async ({
	...
	const title = dict.favoritesPage.meta.title;
	const description = dict.favoritesPage.meta.description;
...
export default async function Page({ params }: PageProps) {
	...
	return <FavoritesPage lang={lang} dict={dict.favoritesPage} />;
}
