...
export const dictionaryKeys = {
  ...
  random: (cefr?: string) =>
    [...dictionaryKeys.all, "random", cefr] as const,
...
export function useRandomEntry(cefr?: string) {
  return useQuery({
    queryKey: dictionaryKeys.random(cefr),
    queryFn: () => dictionaryApi.getRandom(cefr),
    staleTime: 0,
  });
}
